...
import ontroller.AddRoomController;
...
if (result == JFileChooser.APPROVE_OPTION) {
    ...
    try {
        // Remove timestamp - use original filename
        String fileName = selectedFile.getName();
        
        String projectPath = System.getProperty("user.dir");
        // Change "images" to "src/Images" to match your folder structure
        File imagesDir = new File(projectPath, "src" + File.separator + "Images");
        if (!imagesDir.exists()) {
            imagesDir.mkdirs();
        }
